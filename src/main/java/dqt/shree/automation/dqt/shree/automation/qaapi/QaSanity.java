...
public class QaSanity {
    ...
    static final Logger logger= Logger.getLogger(QaSanity.class.getName());
    ...
    public static void yamlFileToMap() throws FileNotFoundException {
        Yaml yaml = new Yaml();
        String path = "src/main/properties/qa_url.yaml";
        ...
        String path2 = "src/main/properties/qa.yaml";
    ...
    private static void abc(long elapsedTime, String responseBody) {
        DateFormat dateFormat = new SimpleDateFormat(A);
        Date date = new Date();
        try(FileWriter writer = new FileWriter("getinvoice_qa" + " " + dateFormat.format(date) + ".txt", true)) {
    ...
    private static void bcd(long elapsedTime, String responseBody2) {
        DateFormat dateFormat = new SimpleDateFormat(A);
        Date date = new Date();
        try(FileWriter writer = new FileWriter("posttranssubmitcorrection_qa" + " " + dateFormat.format(date) + ".txt", true)) {
    ...
    public static void csvFile()  {
        ...
        try(PrintWriter pw = new PrintWriter(new File("C:\\API_CSV\\QA\\" + "QA " + dt0 + ".csv"))) {
    ...
    private static void invoiceGet(StringBuilder sb) throws IOException, JSONException {
        try {
            ...
            String url1 = "http://uscdc01tljdv003.globalservices.bcdtravel.local:8080/DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getInvoice/" + v;
