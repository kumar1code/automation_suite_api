...
public class dev_yml_auto {
   ...
   private static int count1;
    ...
    static final Logger logger= Logger.getLogger(dev_yml_auto.class.getName());

    public static void yamlFileToMap() throws FileNotFoundException {
        Yaml yaml = new Yaml();
        String path = "src/main/properties/dev_url.yaml";
        ...
        String path2 = "src/main/properties/dev.yaml";
    ...
    private static void abc(long elapsedTime, String responseBody) {
        DateFormat dateFormat = new SimpleDateFormat(A);
        Date date = new Date();
        try(FileWriter writer = new FileWriter("getinvoice_dev" + " " + dateFormat.format(date) + ".txt", true)) {
    ...
    private static void bcd(long elapsedTime, String responseBody2) {
        DateFormat dateFormat = new SimpleDateFormat(A);
        Date date = new Date();
        try(FileWriter writer = new FileWriter("posttranssubmitcorrection_dev" + " " + dateFormat.format(date) + ".txt", true)) {
    ...
    public static void csvFile()  {
        ...
        try(PrintWriter pw = new PrintWriter(new File("C:\\API_CSV\\DEV\\" + "Dev " + dt0 + ".csv"))) {
    ...
    private static void invoiceGet(StringBuilder sb) throws IOException, JSONException {
        try {
            ...
            String url1 = "http://uscdc01tljdv002.globalservices.bcdtravel.local:8080/DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getInvoice/" + v;
    ...
    private static void pOSTTrans2(StringBuilder sb) throws IOException, JSONException {
        try {
            ...
            //String keys2=myResponse8.keySet();
            //Iterator<String> keys2 = Iterator<String>myResponse8.keys();
    ...
    private static void pOSTTrans1(StringBuilder sb) throws IOException, JSONException {
        try {
            ...
            //Iterator<String> keys1 = Iterator<String> myResponse6.keys();
