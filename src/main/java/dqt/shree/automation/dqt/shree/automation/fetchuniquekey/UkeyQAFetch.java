...
public class UkeyQAFetch {

    static final Logger logger= Logger.getLogger(UkeyQAFetch.class.getName());
    ...
    public static void uniquekey() throws JSONException,IOException {
        ...
        try(FileWriter writer = new FileWriter("C:\\Uniquekey\\QA\\uniquekeyqa" + " " + dateFormat.format(date) + ".txt", true)) {
    ...
    private static void qauky(HashSet<String> keystore, JSONArray objJSONArray) {
        String v0;
        try {
            for (int l = 0; l <= 5; l++) {
