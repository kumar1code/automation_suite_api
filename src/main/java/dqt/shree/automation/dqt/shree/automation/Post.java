...
//
	...
	public static void pagination() throws Exception {
		...
		postAPIrunner("http://uscdc01tljdv003.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getAllTransErrorsWithPagination/1/2", "C:\\API\\Requests\\pagination.txt", "C:\\API\\QA\\Responses\\pagination_qa");
	}


	public static void getAllErrorFieldsForGrp() throws Exception {

		postAPIrunner("http://uscdc01tljdv003.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getAllErrorFieldsForGrp", "C:\\API\\Requests\\getAllErrorFieldsForGrp.txt", "C:\\API\\QA\\Responses\\getAllErrorFieldsForGrp_qa");
	}


	public static void getTransErrors() throws Exception {

		postAPIrunner("http://uscdc01tljdv003.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getTransErrors/1/2", "C:\\API\\Requests\\getTransErrors.txt", "C:\\API\\QA\\Responses\\getTransErrors_qa");
	}


	public static void getTransErrorsCount() throws Exception {

		postAPIrunner("http://uscdc01tljdv003.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getTransErrorsCount", "C:\\API\\Requests\\getTransErrorsCount.txt", "C:\\API\\QA\\Responses\\getTransErrorsCount_qa");
	}


	public static void getFilteredTransErrors() throws Exception {

		postAPIrunner("http://uscdc01tljdv003.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getFilteredTransErrors/1/500", "C:\\API\\Requests\\getFilteredTransErrors.txt", "C:\\API\\QA\\Responses\\getFilteredTransErrors_qa");
	}


	public static void updateBulkCorrectWithFilterGrp() throws Exception {

		postAPIrunner("http://uscdc01tljdv003.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/updateBulkCorrectWithFilterGrp", "C:\\API\\Requests\\updateBulkCorrectWithFilterGrp.txt", "C:\\API\\QA\\Responses\\updateBulkCorrectWithFilterGrp_qa");
	}


	public static void updateBulkIgnoreWithFilterGrp() throws Exception {

		postAPIrunner("http://uscdc01tljdv003.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/updateBulkIgnoreWithFilterGrp", "C:\\API\\Requests\\updateBulkIgnoreWithFilterGrp.txt", "C:\\API\\QA\\Responses\\updateBulkIgnoreWithFilterGrp_qa");
	}
	...
	public static void getInvoice() throws Exception {
		...
		try {
			//Define a postRequest request
			HttpGet getRequest = new HttpGet("http://uscdc01tljdv003.globalservices.bcdtravel.local:8080/DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getInvoice/20190708CAIC1830271681");
			//Set the API media type in http content-type header
	...
	public static void postTransSubmitCorrection() throws Exception {
		...
		try {
			...
			HttpPost postRequest = new HttpPost("http://uscdc01tljdv003.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/postTransSubmitCorrection");
			postRequest.addHeader("content-type", "application/json");
			...
			try {
				DateFormat dateFormat = new SimpleDateFormat("(yyyy-MM-dd HH-mm-ss)");
				Date date = new Date();
				FileWriter writer = new FileWriter("posttranssubmitcorrection_qa" + " " + dateFormat.format(date) + ".txt", true);
...
//        int path2= num.nextInt( 50 );
//		String path ="C:\\API_CSV\\QA\\"+ path2+ ".csv";
		PrintWriter pw = new PrintWriter(new File("C:\\API_CSV\\QA\\"+"QA "+dt0+".csv"));
...
//		//Post order = mapper.readValue(new File("src/main/java/url.yaml"), Post.class);
//		Post order = new Post("http://uscdc01tljdv003.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getTransErrors/1/2");
//		mapper.writeValue(new File("src/main/Java/url2.yaml"), order);



		DefaultHttpClient httpClient = new DefaultHttpClient();
		HttpPost postRequest = new HttpPost("http://uscdc01tljdv003.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getTransErrors/1/2");
		postRequest.addHeader("content-type", "application/json");
		...
		HttpPost postRequest2 = new HttpPost("http://uscdc01tljdv003.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getAllErrorFieldsForGrp");
		...
		HttpPost postRequest3 = new HttpPost("http://uscdc01tljdv003.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getTransErrorsCount");
		postRequest3.addHeader("content-type", "application/json");

		StringEntity[] postRequests3 = new StringEntity[1];
		StringEntity entity2 = new StringEntity(("{\"groups\":[{\"groupId\":\"admin2\",\"include\":[{\"dataid\": [\"BE\"],\"globalclientcd\": [\"1003\"]}],\"exclude\":[{\"dataid\": [\"IC\"],\"globalclientcd\": [\"1234\"]}],\"includeCriticalErrors\": \"1\"}]}"));
		...
		HttpPost postRequest4 = new HttpPost("http://uscdc01tljdv003.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getAllTransErrorsWithPagination/1/2");
		...
		HttpPost postRequest5 = new HttpPost("http://uscdc01tljdv003.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getFilteredTransErrors/1/500");
		...
		String url1= "http://uscdc01tljdv003.globalservices.bcdtravel.local:8080/DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getInvoice/" + ukey;
...
//		    System.out.println(flattenJSONMap);
		...
		HttpPost postRequest7 = new HttpPost("http://uscdc01tljdv003.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/postTransSubmitCorrection");
		...
		HttpPost postRequest8 = new HttpPost("http://uscdc01tljdv003.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/postTransSubmitCorrection");
