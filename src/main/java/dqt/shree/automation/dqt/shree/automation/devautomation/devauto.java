...
//
    ...
    public static void pagination() throws Exception {
        ...
        postAPIrunner("http://uscdc01tljdv002.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getAllTransErrorsWithPagination/1/2", "C:\\API\\Requests\\pagination.txt", "C:\\API\\Dev\\Responses\\pagination_dev");
    }


    public static void getAllErrorFieldsForGrp() throws Exception {

        postAPIrunner("http://uscdc01tljdv002.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getAllErrorFieldsForGrp", "C:\\API\\Requests\\getAllErrorFieldsForGrp.txt", "C:\\API\\Dev\\Responses\\getAllErrorFieldsForGrp_dev");
    }


    public static void getTransErrors() throws Exception {

        postAPIrunner("http://uscdc01tljdv002.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getTransErrors/1/2", "C:\\API\\Requests\\getTransErrors.txt", "C:\\API\\Dev\\Responses\\getTransErrors_dev");
    }


    public static void getTransErrorsCount() throws Exception {

        postAPIrunner("http://uscdc01tljdv002.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getTransErrorsCount", "C:\\API\\Requests\\getTransErrorsCount.txt", "C:\\API\\Dev\\Responses\\getTransErrorsCount_dev");
    }


    public static void getFilteredTransErrors() throws Exception {

        postAPIrunner("http://uscdc01tljdv002.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getFilteredTransErrors/1/5", "C:\\API\\Requests\\getFilteredTransErrors.txt", "C:\\API\\Dev\\Responses\\getFilteredTransErrors_dev");
    }


    public static void updateBulkCorrectWithFilterGrp() throws Exception {

        postAPIrunner("http://uscdc01tljdv002.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/updateBulkCorrectWithFilterGrp", "C:\\API\\Requests\\updateBulkCorrectWithFilterGrp.txt", "C:\\API\\Dev\\Responses\\updateBulkCorrectWithFilterGrp_dev");
    }


    public static void updateBulkIgnoreWithFilterGrp() throws Exception {

        postAPIrunner("http://uscdc01tljdv002.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/updateBulkIgnoreWithFilterGrp", "C:\\API\\Requests\\updateBulkIgnoreWithFilterGrp.txt", "C:\\API\\Dev\\Responses\\updateBulkIgnoreWithFilterGrp_dev");
    }
    ...
    public static void getInvoice() throws Exception {
        ...
        try {
            //Define a postRequest request
            HttpGet getRequest = new HttpGet("http://uscdc01tljdv002.globalservices.bcdtravel.local:8080/DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getInvoice/20190417CAIC1803591002");
            //Set the API media type in http content-type header
            ...
            try {
                DateFormat dateFormat = new SimpleDateFormat("(yyyy-MM-dd HH-mm-ss)");
                Date date = new Date();
                FileWriter writer = new FileWriter("getinvoice_dev" + " " + dateFormat.format(date) + ".txt", true);
    ...
    public static void postTransSubmitCorrection() throws Exception {
        ...
        try {
            ...
            HttpPost postRequest = new HttpPost("http://uscdc01tljdv002.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/postTransSubmitCorrection");
            postRequest.addHeader("content-type", "application/json");
            ...
            try {
                DateFormat dateFormat = new SimpleDateFormat("(yyyy-MM-dd HH-mm-ss)");
                Date date = new Date();
                FileWriter writer = new FileWriter("posttranssubmitcorrection_dev" + " " + dateFormat.format(date) + ".txt", true);
    ...
    public static void csvFile() throws Exception {
        ...
        try {
            ...
            PrintWriter pw = new PrintWriter(new File("C:\\API_CSV\\DEV\\"+"Dev "+dt0+".csv"));
            ...
            DefaultHttpClient httpClient = new DefaultHttpClient();
            HttpPost postRequest = new HttpPost("http://uscdc01tljdv002.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getTransErrors/1/2");
            postRequest.addHeader("content-type", "application/json");
            ...
            HttpPost postRequest2 = new HttpPost("http://uscdc01tljdv002.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getAllErrorFieldsForGrp");
            ...
            HttpPost postRequest3 = new HttpPost("http://uscdc01tljdv002.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getTransErrorsCount");
            ...
            HttpPost postRequest4 = new HttpPost("http://uscdc01tljdv002.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getAllTransErrorsWithPagination/1/2");
            ...
            HttpPost postRequest5 = new HttpPost("http://uscdc01tljdv002.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getFilteredTransErrors/1/500");
            ...
            String url1= "http://uscdc01tljdv002.globalservices.bcdtravel.local:8080/DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getInvoice/" + ukey;
...
//                    if(!myResponse6.getString(key1).equals(info) )

                    //System.out.println(myResponse6.getString(key1));
                      count1++;
