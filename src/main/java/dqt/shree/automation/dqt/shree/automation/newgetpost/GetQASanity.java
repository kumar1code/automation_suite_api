...
public class GetQASanity {
    ...
    private static final String URL="http://uscdc01tljdv003.globalservices.bcdtravel.local:8080//DQTAPIProject-0.0.1-SNAPSHOT/InvApi/postTransSubmitCorrection";
    ...
    static final Logger logger= Logger.getLogger(GetQASanity.class.getName());
    ...
    public static void csvFile()  {
        ...
        StringEntity[] postRequests = getRequestArray("C:\\Uniquekey\\QA\\uniquekeyqa.txt");
        List<String> words = readArray("C:\\Uniquekey\\QA\\uniquekeyqa.txt");


        DateFormat dateFormat0 = new SimpleDateFormat("dd-MM-yyyy hh-mm-ss");
        Date date0 = new Date();
        String dt0 = dateFormat0.format(date0);
        try(PrintWriter pw = new PrintWriter(new File("C:\\API_CSV\\GETPOST\\" + "getpostqa " + dt0 + ".csv"))) {
    ...
    private static void getInvc(List<String> words, StringBuilder sb, int i) throws IOException, JSONException {
        try {
            ...
            String url1 = "http://uscdc01tljdv003.globalservices.bcdtravel.local:8080/DQTAPIProject-0.0.1-SNAPSHOT/InvApi/getInvoice/" + ukey2;
    ...
    private static void gtInvcSave(List<String> words, int i, long elapsedTime6) {
        ...
        Date date = new Date();
        String x = "C:\\API_CSV\\GETPOST\\Response\\QA\\" + words.get(i);
